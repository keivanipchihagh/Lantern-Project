    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_joined', models.DateTimeField(default=datetime.datetime(2021, 2, 23, 12, 1, 27, 691017))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_opened', models.DateTimeField(default=datetime.datetime(2021, 2, 23, 12, 1, 27, 691017))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datetime', models.DateTimeField(default=datetime.datetime(2021, 2, 23, 12, 1, 27, 692087))),
                ('site', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='core.coresite')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='core.coreuser')),
            ],
            options={
